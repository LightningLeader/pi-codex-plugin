...
export function createJobProgressUpdater(workspaceRoot, jobId) {
  let lastPhase = null;
  let lastPiSessionId = null;
  let lastPiSessionFile = null;
  ...
  return (event) => {
    ...
    if (normalized.piSessionId && normalized.piSessionId !== lastPiSessionId) {
      lastPiSessionId = normalized.piSessionId;
      patch.piSessionId = normalized.piSessionId;
      changed = true;
    }
...
export async function runTrackedJob(job, runner, options = {}) {
  ...
  try {
    ...
    writeJobFile(job.workspaceRoot, job.id, {
      ...
      piSessionId: execution.piSessionId ?? null,
      piSessionFile: execution.piSessionFile ?? null,
      pid: null,
