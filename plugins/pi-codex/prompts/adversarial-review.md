...
If the change looks safe, return `verdict: "approve"`, an empty `findings` array, and explain why in the summary.
</calibration_rules>
...
And that the fenced ```json block contains valid JSON that parses cleanly.
</final_check>
